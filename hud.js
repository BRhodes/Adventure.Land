/*
USAGE:
init_xptimer(minref) outside interval function
update_xptimer() inside interval function

init_xptimer(5) => tracker resets every 5 minutes
init_xptimer() => tracker resets every 1 minute (default value)
*/
...
init_xptimer();
setInterval(update_xptimer, 1000);
